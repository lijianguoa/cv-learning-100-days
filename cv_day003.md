...
### 图像处理库的演进
- **1960s-1970s**：NASA使用Fortran编写图像处理程序，用于卫星图像校正
...
### OpenCV的诞生
1999年，Intel在俄罗斯的团队发布了OpenCV，最初目的是促进计算机视觉研究和产品开发。如今OpenCV已成为全球使用最广泛的计算机视觉库，支持C++、Python、Java等多种语言。[^1]

[^1]: [Wikipedia: OpenCV - OpenCV的起源与发展](https://en.wikipedia.org/wiki/OpenCV)
...
#### OpenCV读取图像[^2]
[^2]: [OpenCV官方文档: Reading and Writing Images](https://docs.opencv.org/4.x/d4/d8c/group__imgcodecs.html)
...
> 📎 **waitKey的原理**：[OpenCV中waitKey()的工作机制](https://docs.opencv.org/4.x/d7/dfc/group__highgui.html#ga5628525ad12f2d9c36e5c8e8c67354ac)
...
> 📎 **NumPy与图像**：[NumPy数组与图像表示](https://numpy.org/doc/stable/user/whatisnumpy.html) - 理解图像在内存中如何存储

### 3. 基本几何变换

#### 缩放（Resize）[^3]
[^3]: [Wikipedia: Image Scaling - 图像缩放与插值算法](https://en.wikipedia.org/wiki/Image_scaling)
...
> 📎 **插值算法原理**：[双线性插值与双三次插值的数学原理](https://en.wikipedia.org/wiki/Bilinear_interpolation)
...
#### 平移（Translation）[^4]
[^4]: [Wikipedia: Translation (geometry) - 几何平移变换](https://en.wikipedia.org/wiki/Translation_(geometry))
...
> 📎 **仿射变换矩阵**：[仿射变换的数学表示](https://en.wikipedia.org/wiki/Affine_transformation)
...
> 📎 **旋转矩阵推导**：[二维旋转矩阵的数学原理](https://en.wikipedia.org/wiki/Rotation_matrix)

### 4. 仿射变换与透视变换

#### 仿射变换（Affine Transformation）[^5]
[^5]: [Wikipedia: Affine transformation - 仿射变换详解](https://en.wikipedia.org/wiki/Affine_transformation)
...
> 📎 **OpenCV官方文档**：[getAffineTransform和warpAffine函数](https://docs.opencv.org/4.x/da/d6a/group__imgproc__transform.html)

#### 透视变换（Perspective Transformation）[^6]
[^6]: [Wikipedia: Perspective transformation - 透视变换与投影几何](https://en.wikipedia.org/wiki/Homography_(computer_vision))
...
> 📎 **透视变换应用**：[文档扫描仪的透视矫正原理](https://www.pyimagesearch.com/2014/09/01/complete-guide-building-image-scanners-cameras-opencv/)
...
> 📎 **ROI技术**：计算机视觉中的[感兴趣区域(Region of Interest)提取技术](https://docs.opencv.org/3.4/d2/df0/tutorial_js_geometric_transformations.html)
...
Gary Bradski是OpenCV的开创者之一。1999年，他在Intel工作时发起了OpenCV项目，目标是创建一个开源的计算机视觉库，促进学术研究和商业应用。[^7]

[^7]: [Gary Bradski - Wikipedia](https://en.wikipedia.org/wiki/Gary_Bradski)
...
[^8]: [OpenCV: Geometric Image Transformations](https://docs.opencv.org/4.x/da/d6a/group__imgproc__transform.html)
...
> 📎 **实战教程**：[PyImageSearch: Building an Image Scanner](https://www.pyimagesearch.com/2014/09/01/complete-guide-building-image-scanners-cameras-opencv/) - 完整的文档扫描项目教程
...
2. **进阶题**：在缩放图像时，为什么OpenCV提供了多种插值方法（如INTER_AREA、INTER_CUBIC）？它们各自的优势和劣势是什么？
   > 💡 **提示**：了解[双线性插值与双三次插值的数学原理](https://en.wikipedia.org/wiki/Bilinear_interpolation)

3. **思考题**：仿射变换和透视变换的数学表示有什么区别？仿射变换矩阵是2×3，透视变换矩阵是3×3，为什么维度不同？
   > 💡 **提示**：参考[投影几何与单应性变换](https://en.wikipedia.org/wiki/Homography_(computer_vision))
...
| 仿射变换 | Affine Transformation | [保持平行性的几何变换](https://en.wikipedia.org/wiki/Affine_transformation) |
| 透视变换 | Perspective Transformation | [可改变平行线的几何变换](https://en.wikipedia.org/wiki/Homography_(computer_vision)) |
| 插值 | Interpolation | [计算新像素值的方法](https://en.wikipedia.org/wiki/Image_scaling) |
| 裁剪 | Crop | 提取图像的矩形子区域 |
| ROI | Region of Interest | 感兴趣区域 |
| 变换矩阵 | Transformation Matrix | 定义几何变换的数学矩阵 |
| 双线性插值 | Bilinear Interpolation | [基于4个邻近点的插值方法](https://en.wikipedia.org/wiki/Bilinear_interpolation) |
